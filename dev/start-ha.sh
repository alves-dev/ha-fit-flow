#!/bin/sh
# Start the local Home Assistant instance used to test FitFlow.
...
readonly LOG_FILE="/tmp/ha-fit-flow-home-assistant.log"
...
cd "$HA_CORE_DIR"
# Do not let the FitFlow virtual environment override Home Assistant's.
unset VIRTUAL_ENV
